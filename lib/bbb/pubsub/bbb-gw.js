    ...
    if (header){
      switch (header.name) {
        ...
        case C.DISCONNECT_USER:
          ...
          break;
        case C.TRANSCODER_ERROR:
          meetingId = payload[C.MEETING_ID];
          this.emit(C.TRANSCODER_ERROR+meetingId, payload);
          break;
          // 2x messages
        ...
        case C.USER_CAM_BROADCAST_STARTED_2x:
          ...
          break;
        // SCREENSHARE
        case C.PRESENTER_ASSIGNED_MESSAGE:
          meetingId = payload[C.MEETING_ID];
          this.emit(C.PRESENTER_ASSIGNED_MESSAGE+meetingId, payload);
          break;
        default:
